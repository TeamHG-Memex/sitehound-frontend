ngApp.controller('ddTrainingController', ['$scope', '$filter', '$modal', '$routeParams', '$interval', 'domFactory', 'seedFactory', 'seedUrlFactory', 'deepcrawlerFactory', 'eventFactory',
function ($scope, $filter, $modal, $routeParams, $interval, domFactory, seedFactory, seedUrlFactory, deepcrawlerFactory, eventFactory){


//    $scope.startDdCrawling = function(){
//        eventFactory.postDdTraining($scope.workspaceId, "start");
//    };
//
//    $scope.stopDdCrawling = function(){
//        eventFactory.postDdTraining($scope.workspaceId, "stop");
//    };
//
